...
const API_URL = 'https://auth.riseoftheblacksun.eu/register';
      ...
      <div className="max-w-md w-full">
        <motion.div
          ...
          className="bg-gradient-to-br from-black/80 via-black/50 to-black/80 
            ...
            hover:border-green-500/50 transition-all duration-300 relative overflow-hidden"
        >
          {/* Декоративные элементы */}
          <div className="absolute -top-16 -right-16 w-32 h-32 bg-green-500/10 rounded-full blur-2xl" />
          <div className="absolute -bottom-16 -left-16 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl" />
          ...
          <div className="relative space-y-4">
            ...
            <div className="text-center space-y-1 mb-6">
              ...
              <motion.p
                ...
                className="text-xs text-green-500 uppercase tracking-wider font-medium"
              >
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-4 h-10 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg
                    text-sm text-white focus:border-green-500 focus:ring-1 focus:ring-green-500/20 
            ...
            <div className="text-center mt-6">
              ...
              >
                Уже есть аккаунт? <span className="text-green-500">Войти</span>
              </a>
            </div>
          </div>
        </motion.div>
